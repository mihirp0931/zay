...
class Product(models.Model):
	...
	def __str__(self):
		return self.product_seller.name+" - "+self.product_collection+" - "+self.product_category
...
class Whishlist(models.Model):
	...
	def __str__(self):
		return self.user.name+ " - " +self.product.product_collection
